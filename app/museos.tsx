...
export default function Museos() {
  ...
  */
  ...
  return (
    <div
      ref={ref}
      className="h-[372px] px-[39px] sm:px-0 xs:h-[423px] sm:h-[273px] md:h-[333px] lg:h-[413px] xl:h-[478px] 2xl:h-[573px] relative z-0"
    >
      ...
      <div className={`sm:hidden ${container} z-0`}>
        <div className="flex flex-col">
          ...
          <Image
            ...
            height={512}
            alt="Obras expuestas en museo"
            className="mt-[18px] w-auto h-[200px] mx-auto"
          />
