...
export default function Panel({
  ...
  return (
    <div style={{boxShadow:"0px 4px 8px 0px rgba(0, 0, 0, .5)"}} className="max-w-[254px]">
      <Image
        src={image}
        alt={title}
        width={width}
      ...
      <div className="px-[16px] py-[11px] flex flex-col gap-[5px] text-[8px] xs:text-[10px] md:text-[12px] text-[#222222]">
        <p className="text-[#ffb340] text-[9px] xs:[11px] md:text-[13px] uppercase font-bold">{title}</p>
